package com.example.saftyapp.service;
...
import com.example.saftyapp.SessionManager;
...
import com.example.saftyapp.util.CameraCaptureHelper;
...
public class EmergencyService extends Service implements SensorEventListener {
    ...
    private Notification buildMonitorNotification() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("Guardian Safety Enabled")
